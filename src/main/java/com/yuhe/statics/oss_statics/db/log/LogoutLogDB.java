...
public class LogoutLogDB extends AbstractDB{
	
	private static final String[] LOG_COLS = {"HostID", "Uid", "Urs", "OnTime", "Level", "VipLevel", "IsVip", "Name", "Time","Gold",
	...
	public boolean batchInsert(String platformID, List<Map<String, String>> results) {
		...
		while(it.hasNext()){
			...
			sb.append("insert into ").append(platformID).append("_log.tblLogoutLog_")
