...
public class TaskLogDB extends AbstractDB {

	private static final String[] LOG_COLS = {"HostID", "Uid", "Urs", "AchieveId", "FinishLevel", "Time"};
	...
	public boolean batchInsert(String platformID, List<Map<String, String>> results) {
		...
		while (it.hasNext()) {
			...
			sb.append("insert into ").append(platformID).append("_log.tblTaskLog_").append(date).append("(")
