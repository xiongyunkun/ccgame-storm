...
public class ReNameLogDB extends AbstractDB {

	private static final String[] LOG_COLS = {"HostID", "Uid", "Urs", "OldName", "NewName", "NameChangedTime", "Time"};
	@Override
	...
	public boolean batchInsert(String platformID, List<Map<String, String>> results) {
		...
		while(it.hasNext()){
			...
			sb.append("insert into ").append(platformID).append("_log.tblRenameLog_")
