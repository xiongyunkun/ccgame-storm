...
public class LevelUpLogDB extends AbstractDB {
	
	private static final String[] LOG_COLS = {"HostID", "Uid", "OrgLevel","NewLevel","Exp","Urs",
	...
	public boolean batchInsert(String platformID, List<Map<String, String>> results) {
		...
		while(it.hasNext()){
			...
			sb.append("insert into ").append(platformID).append("_log.tblLevelUpLog_")
