...
public class CardLogDB extends AbstractDB {

	private static final String[] LOG_COLS = { "HostID", "Uid", "Urs", "Name", "CardUid", "CardTypeId", "CardName",
			"Time" };
	...
	public boolean batchInsert(String platformID, List<Map<String, String>> results) {
		...
		while (it.hasNext()) {
			...
			sb.append("insert into ").append(platformID).append("_log.tblCardLog_").append(date).append("(")
