...
public class LuckyDrawLogDB extends AbstractDB {

	private static final String[] LOG_COLS = {"HostID", "Uid", "Urs", "Name","Times", "ProcType", "Bonus", "Time"};
	...
	public boolean batchInsert(String platformID, List<Map<String, String>> results) {
		...
		while (it.hasNext()) {
			...
			sb.append("insert into ").append(platformID).append("_log.tblLuckyDrawLog_").append(date).append("(")
