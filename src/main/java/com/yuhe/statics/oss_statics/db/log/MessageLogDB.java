...
public class MessageLogDB extends AbstractDB {

	private static final String[] LOG_COLS = {"HostID", "Uid", "SenderUid", "SenderName", "TargetUid", "Title", "Content", 
			"Bonus", "Urs", "Name", "Time"};
	...
	public boolean batchInsert(String platformID, List<Map<String, String>> results) {
		...
		while (it.hasNext()) {
			...
			sb.append("insert into ").append(platformID).append("_log.tblMessageLog_").append(date).append("(")
