...
public class ItemLogDB extends AbstractDB {

	private static final String[] LOG_COLS = { "HostID", "Uid", "Name", "OperationType", "Type", "Reason", "Memo",
	...
	public boolean batchInsert(String platformID, List<Map<String, String>> results) {
		...
		while (it.hasNext()) {
			...
			sb.append("insert into ").append(platformID).append("_log.tblItemLog_").append(date).append("(")
