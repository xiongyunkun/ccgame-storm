...
public class ClientLoadLogDB extends AbstractDB {

	private static final String[] LOG_COLS = {"HostID", "Vfd", "Uid", "Urs", "Step", "IMEI", "PhoneInfo", "Time"};
	...
	public boolean batchInsert(String platformID, List<Map<String, String>> results) {
		...
		while (it.hasNext()) {
			...
			sb.append("insert into ").append(platformID).append("_log.tblClientLoadLog_").append(date).append("(")
