...
public class MoneyLogDB extends AbstractDB {
	
	private static final String[] LOG_COLS = {"HostID", "Uid", "Urs", "Changes", "Reason", "Remain", "Name", "Time"};
	@Override
	...
	public boolean batchInsert(String platformID, List<Map<String, String>> results) {
		...
		while(it.hasNext()){
			...
			sb.append("insert into ").append(platformID).append("_log.tblMoneyLog_")
