...
public class ChallengeLogDB extends AbstractDB {

	private static final String[] LOG_COLS = { "HostID", "Uid", "Urs", "Name", "Level", "ChapterId", "Idx", "StageId",
			"IsWin", "Time" };
	...
	public boolean batchInsert(String platformID, List<Map<String, String>> results) {
		...
		while (it.hasNext()) {
			...
			sb.append("insert into ").append(platformID).append("_log.tblChallengeLog_").append(date).append("(")
