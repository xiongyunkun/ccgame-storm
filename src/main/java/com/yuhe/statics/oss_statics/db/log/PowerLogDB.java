...
public class PowerLogDB extends AbstractDB {

	private static final String[] LOG_COLS = {"HostID", "Uid", "Urs", "DPower", "Reason", "Power", "Name", "Time"};
	...
	public boolean batchInsert(String platformID, List<Map<String, String>> results) {
		...
		while (it.hasNext()) {
			...
			sb.append("insert into ").append(platformID).append("_log.tblPowerLog_").append(date).append("(")
