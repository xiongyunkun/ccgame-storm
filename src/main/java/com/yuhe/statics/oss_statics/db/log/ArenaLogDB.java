...
public class ArenaLogDB extends AbstractDB {

	private static final String[] LOG_COLS = { "HostID", "Uid", "Urs", "Name", "TargetUid", "TargetUrs", "TargetName",
			"Rank", "TRank", "FightGroup", "DefendGroup", "FightName", "DefendName", "IsWin", "Time" };
	...
	public boolean batchInsert(String platformID, List<Map<String, String>> results) {
		...
		while (it.hasNext()) {
			...
			sb.append("insert into ").append(platformID).append("_log.tblArenaLog_").append(date).append("(")
