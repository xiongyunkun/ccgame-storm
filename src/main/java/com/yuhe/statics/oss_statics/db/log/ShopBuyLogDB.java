...
public class ShopBuyLogDB extends AbstractDB {

	private static final String[] LOG_COLS = { "HostID", "Uid", "Urs", "Name", "ShopId", "ItemType", "Amount",
	...
	public boolean batchInsert(String platformID, List<Map<String, String>> results) {
		...
		while (it.hasNext()) {
			...
			sb.append("insert into ").append(platformID).append("_log.tblShopBuyLog_").append(date).append("(")
