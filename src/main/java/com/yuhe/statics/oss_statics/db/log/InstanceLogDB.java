...
public class InstanceLogDB extends AbstractDB {

	private static final String[] LOG_COLS = {"HostID", "Uid", "Name", "Urs", "StageId", "StageType", "Times","NotPassEvent", 
	...
	public boolean batchInsert(String platformID, List<Map<String, String>> results) {
		...
		while (it.hasNext()) {
			...
			sb.append("insert into ").append(platformID).append("_log.tblInstanceLog_").append(date).append("(")
