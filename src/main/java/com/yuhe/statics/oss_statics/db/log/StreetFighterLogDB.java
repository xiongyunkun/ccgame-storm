...
public class StreetFighterLogDB extends AbstractDB {

	private static final String[] LOG_COLS = { "HostID", "Uid", "Urs", "Name", "Level", "SelfCF", "FightGroup",
	...
	public boolean batchInsert(String platformID, List<Map<String, String>> results) {
		...
		while (it.hasNext()) {
			...
			sb.append("insert into ").append(platformID).append("_log.tblStreetFighterLog_").append(date).append("(`")
