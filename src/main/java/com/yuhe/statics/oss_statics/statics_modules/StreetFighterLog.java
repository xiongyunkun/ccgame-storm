...
import com.yuhe.statics.oss_statics.db.log.StreetFighterLogDB;
import com.yuhe.statics.oss_statics.utils.RegUtils;

import net.sf.json.JSONObject;

public class StreetFighterLog extends AbstractStaticsModule {
	...
	public boolean execute(List<String> logList) {
		...
		while (it.hasNext()) {
			...
			List<Map<String, String>> platformResult = platformResults.get(platformID);
			AbstractDB db = new StreetFighterLogDB();
