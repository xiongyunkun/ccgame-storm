...
public class TaskLog extends AbstractLogModule {

	private static final String[] LOG_COLS = { "Uid", "Urs", "AchieveId", "FinishLevel", "SDKInfo" };
	private static final String[] DB_COLS = { "HostID", "Uid", "Urs", "AchieveId", "FinishLevel", "Time" };
	private static String TBL_NAME = "tblTaskLog";
