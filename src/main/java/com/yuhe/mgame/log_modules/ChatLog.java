...
public class ChatLog extends AbstractLogModule {

	private static final String[] LOG_COLS = { "Uid", "Name", "ChannelID", "Msg", "MD5", "SDKInfo" };
	private static final String[] DB_COLS = { "HostID", "Uid", "ChannelID", "Time", "Msg", "MD5" };
	private static String TBL_NAME = "tblChatLog";
