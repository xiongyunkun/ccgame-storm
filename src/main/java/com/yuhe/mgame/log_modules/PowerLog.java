...
public class PowerLog extends AbstractLogModule {

	private static final String[] LOG_COLS = { "Uid", "Urs", "DPower", "Reason", "Power", "Name", "SDKInfo" };
	private static final String[] DB_COLS = { "HostID", "Uid", "Urs", "DPower", "Reason", "Power", "Name", "Time" };
	private static String TBL_NAME = "tblPowerLog";
