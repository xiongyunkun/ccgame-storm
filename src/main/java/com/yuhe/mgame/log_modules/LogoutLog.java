 ...
 *
 */
public class LogoutLog extends AbstractLogModule {
	// 需要提取的列，注意要跟数据库中对应，前面的HostID和后面的时间都不要在这里填
	private static final String[] LOG_COLS = { "Uid", "Urs", "OnTime", "Level", "VipLevel", "IsVip", "Name", "Gold",
			"TotalGold", "Money", "Ip", "Fighting", "SDKInfo", "PhoneInfo", "HeadId" };
	private static final String[] DB_COLS = { "HostID", "Uid", "Urs", "OnTime", "Level", "VipLevel", "IsVip", "Name",
			"Time", "Gold", "TotalGold", "Money", "Ip", "Fighting", "PhoneInfo" };
