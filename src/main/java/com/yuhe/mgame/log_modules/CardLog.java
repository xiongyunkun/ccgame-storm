...
public class CardLog extends AbstractLogModule {

	private static final String[] LOG_COLS = { "Uid", "Urs", "Name", "CardUid", "CardTypeId", "CardName", "SDKInfo" };
	private static final String[] DB_COLS = { "HostID", "Uid", "Urs", "Name", "CardUid", "CardTypeId", "CardName",
			"Time" };
	private static String TBL_NAME = "tblCardLog";
