 ...
 *
 */
public class ArenaLog extends AbstractLogModule {
	...
	private static final String[] DB_COLS = { "HostID", "Uid", "Urs", "Name", "TargetUid", "TargetUrs", "TargetName",
			"Rank", "TRank", "FightGroup", "DefendGroup", "FightName", "DefendName", "IsWin", "Time" };
	private static String TBL_NAME = "tblArenaLog";
