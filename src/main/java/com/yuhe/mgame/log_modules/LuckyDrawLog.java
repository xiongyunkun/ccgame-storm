...
public class LuckyDrawLog extends AbstractLogModule {

	private static final String[] LOG_COLS = { "Uid", "Urs", "Name", "Times", "ProcType", "Bonus", "SDKInfo" };
	private static final String[] DB_COLS = { "HostID", "Uid", "Urs", "Name", "Times", "ProcType", "Bonus", "Time" };
	private static String TBL_NAME = "tblLuckyDrawLog";
