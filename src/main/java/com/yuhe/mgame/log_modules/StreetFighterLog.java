...
public class StreetFighterLog extends AbstractLogModule {

	private static final String[] LOG_COLS = { "Uid", "Urs", "Name", "Level", "SelfCF", "FightGroup", "EnermyName",
			"EnermyGroup", "EnermeCombatForces", "Index", "IsWin", "SDKInfo" };
	private static final String[] DB_COLS = { "HostID", "Uid", "Urs", "Name", "Level", "SelfCF", "FightGroup",
			"EnermyName", "EnermyGroup", "EnermeCombatForces", "`Index`", "IsWin", "Time" };
	private static String TBL_NAME = "tblStreetFighterLog";
