...
public class ShopBuyLog extends AbstractLogModule {

	private static final String[] LOG_COLS = { "Uid", "Urs", "Name", "ShopId", "ItemType", "Amount", "CostType",
			"CostValue", "SDKInfo" };
	private static final String[] DB_COLS = { "HostID", "Uid", "Urs", "Name", "ShopId", "ItemType", "Amount",
			"CostType", "CostValue", "Time" };
	private static String TBL_NAME = "tblShopBuyLog";
