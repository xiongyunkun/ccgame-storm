...
public class MessageLog extends AbstractLogModule {

	private static final String[] LOG_COLS = { "Uid", "SenderUid", "SenderName", "TargetUid", "Title", "Content",
			"Bonus", "Urs", "Name", "SDKInfo" };
	private static final String[] DB_COLS = { "HostID", "Uid", "SenderUid", "SenderName", "TargetUid", "Title",
			"Content", "Bonus", "Urs", "Name", "Time" };
	private static String TBL_NAME = "tblMessageLog";
