...
public class TopChallengeLog extends AbstractLogModule {

	private static final String[] LOG_COLS = { "Uid", "Urs", "Name", "StageId", "StageName", "CurStep", "CardList",
			"IsWin", "Score", "Bonus", "SDKInfo" };
	private static final String[] DB_COLS = { "HostID", "Uid", "Urs", "Name", "StageId", "StageName", "CurStep",
			"CardList", "IsWin", "Score", "Bonus", "Time" };
	private static String TBL_NAME = "tblTopChallengeLog";
