...
public class ReNameLog extends AbstractLogModule {

	// 需要提取的列，注意要跟数据库中对应，前面的HostID和后面的时间都不要在这里填
	private static final String[] LOG_COLS = { "Uid", "Urs", "OldName", "NewName", "NameChangedTime", "SDKInfo" };
	private static final String[] DB_COLS = { "HostID", "Uid", "Urs", "OldName", "NewName", "NameChangedTime", "Time" };
	private static String TBL_NAME = "tblRenameLog";
