...
public class WorldSlayLog extends AbstractLogModule {

	private static final String[] LOG_COLS = { "Uid", "Urs", "Name", "SingleRank", "WorldRank", "UserKillNum",
			"WorldKillNum", "HighestNum", "SDKInfo" };
	private static final String[] DB_COLS = { "HostID", "Uid", "Urs", "Name", "SingleRank", "WorldRank", "UserKillNum",
			"WorldKillNum", "HighestNum", "Time" };
	private static String TBL_NAME = "tblWorldSlayLog";
